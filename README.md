...
GET  /alert-config?device=ID -> {cpu,ram,disk,temperature,ntfyTopic,localOverride} — эффективные пороги устройства, Bearer-токен
...
lib/
  ...
  services/    prefs_store, agent_client (http), wol_sender (udp), push_service (FCM), device_identity
